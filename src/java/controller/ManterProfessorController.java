...
public class ManterProfessorController extends HttpServlet {
    ...
    protected void prepararOperacao(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!operacao.equals("Incluir")) {
                ...
                Usuario usuario= Usuario.obterUsuario(professor.getUsuario().getCpf());
    ...
    private void confirmarOperacao(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            Usuario usuario = new Usuario(cpf, login, senha, nomeCompleto, naturalidade, nacionalidade, rg, orgaoExpedidor, ufrg, dataNascimento, email,estado,cidade,bairro,rua,numero,complemento, "2");

            
            Professor professor = new Professor(numeroRegistroProfessor, areaAtuacao,usuario);
